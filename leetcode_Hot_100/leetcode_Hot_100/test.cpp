...
//     int get(int key) {
//         auto itor = key_to_itor.find(key);
//         if (itor == key_to_itor.end()) {
//             return -1;
//         }
//         auto list_iter = itor->second;
...
//         key_to_itor[key] = cache_list.begin();
//         if (key_to_itor.size() > capacity) {
//             key_to_itor.erase(cache_list.back().first);
//             cache_list.pop_back();
//         }
//     }
...
//     unordered_map<int, list<pair<int, int>>::iterator> key_to_itor;
// };
...
//         int cur = begini;
//         while(inorder[cur] != postorder[posti]){
//             cur++;
//         }

//         posti--;

//         root->right = _buildTree(inorder,postorder,posti,cur + 1,endi);
//         root->left = _buildTree(inorder,postorder,posti,begini,cur - 1);
...
//         int cur = begini;
//         while(inorder[cur] != preorder[previ]){
//             cur++;
//         }
//         previ++;

//         root->left = _buildTree(preorder, inorder, previ,begini,cur - 1);
//         root->right = _buildTree(preorder, inorder, previ, cur + 1,endi);
//         return root;
//     }
// public:
